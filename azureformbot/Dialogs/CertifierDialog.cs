...
{
    [Serializable]
    public class CertifierDialog : IDialog<string>
    {
        ...
        private async Task MessageReceivedAsync(IDialogContext context, IAwaitable<IMessageActivity> result)
        {
            ...
            else
            {
                ...
                {
                    // finish with failure current dialog, remove it from dialog stack and return exception to the calling/parent dialog
